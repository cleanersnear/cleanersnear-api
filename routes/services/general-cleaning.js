...
const generalCleaningHandler = {
    processBooking: async (req, res) => {
        try {
            ...
            console.log('Starting general cleaning booking process...');
            ...
            const response = {
                success: true,
                message: 'General cleaning booking created successfully',
                data: {
            ...
            console.error('General cleaning error:', error);
            res.status(500).json({
                success: false,
                message: 'Failed to process general cleaning booking',
                error: error.message
            });
        }
    }
...
router.post('/submit', generalCleaningHandler.processBooking);
