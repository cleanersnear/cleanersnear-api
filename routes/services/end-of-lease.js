...
const endOfLeaseHandler = {
    processBooking: async (req, res) => {
        try {
            ...
            console.log('Starting end of lease cleaning booking process...');
            ...
            const { data: serviceData, error: serviceError } = await supabase
                ...
                .insert({
                    ...
                    parking: serviceDetails.parking,
                    customer_info: serviceDetails.customerInfo,
            ...
            const response = {
                success: true,
                message: 'End of lease cleaning booking created successfully',
                data: {
            ...
            console.error('End of lease cleaning error:', error);
            res.status(500).json({
                success: false,
                message: 'Failed to process end of lease cleaning booking',
                error: error.message
            });
        }
    }
